		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados",
									"targetURL": "#logaligroupnomina-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupnomina-display": {
								"semanticObject": "logaligroupnomina",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.nomina",
									"url": sap.ui.require.toUrl("logaligroup/nomina")
								}
							}
						}
					}
